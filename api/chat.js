...
//  ULTRA POWERED — Full knowledge of Sahnawaz Ahmed Laskar
//  Place this file at: api/chat.js in your GitHub repo root
// ============================================================
...
export default async function handler(req, res) {
  ...
  if (!apiKey) {
    ...
    return res.status(500).json({ reply: 'AI service is not configured. Please try again later.' });
  }
