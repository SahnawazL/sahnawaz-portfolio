...
`;
  ...
  const MODELS = [
    'meta-llama/llama-4-scout-17b-16e-instruct',      // Primary: 30K TPM — highest free tier limit (~5 msg/min)
    'openai/gpt-oss-120b',                            // Fallback 1: 120B params, most powerful, 8K TPM
    'llama-3.3-70b-versatile',                        // Fallback 2: 70B params, great quality, 12K TPM
    'llama-3.1-8b-instant'                            // Fallback 3: 8B safety net, 500K TPD
  ];
